    ...
    <div className="min-h-screen bg-[#FFFBF7] py-10 md:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          {/* Right Form Column with Brochure Offset Orange Backdrop Frame */}
          <div className="lg:col-span-7 relative group">
            {/* 1. Offset Brand Orange (#F68722) Backdrop Frame */}
            <div className="absolute inset-0 bg-[#F68722] rounded-3xl translate-x-3 translate-y-3 sm:translate-x-4 sm:translate-y-4 -z-10" />

            {/* 2. Main Foreground Form Card */}
            <div className="relative w-full bg-white p-6 sm:p-10 rounded-3xl border-2 border-[#EFE8DF] space-y-6">
              <div>
              ...
              {submitted ? (
                <div className="p-8 bg-emerald-50 rounded-2xl border border-emerald-200 text-center space-y-3">
                  ...
                  <button
                    ...
                    className="mt-2 py-2.5 px-5 bg-[#3B3A3A] text-white text-xs font-bold uppercase rounded-xl cursor-pointer"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className="w-full py-3.5 px-6 bg-[#F68722] hover:bg-[#e07414] text-white font-bold text-xs uppercase tracking-wider rounded-xl active:scale-[0.98] transition-all flex items-center justify-center gap-2 cursor-pointer shadow-md shadow-[#F68722]/20"
                  >
